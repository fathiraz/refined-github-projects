 ...
 *
 * Lives here rather than in `queue.ts` so that leaf consumers like `toast-store`
 * don't pull the queue's dependencies in behind it. Keep this module
 * dependency-free — importing storage or the logger here breaks those suites.
 */
